...
// Sadece kategori "EKONOMİ" olan haberleri çek
...
<body>
  ...
  <h1 style="padding-left: 65%;">EKONAMİ</h1>
    ...
    <?php if($haberler): ?>
      <?php foreach($haberler as $haber): ?>
        <a href="haber.php?id=<?= $haber['id'] ?>" class="card">
          ...
          <?php else: ?>
            <img src="placeholder.jpg" alt="Haber Görseli"> <!-- Görsel yoksa placeholder -->
          <?php endif; ?>
